...
import { FaChalkboardTeacher, FaUniversity, FaSignOutAlt, FaBookOpen, FaEnvelope, FaLayerGroup, FaFileAlt, FaCog, FaClipboardList, FaRobot, FaRocket } from 'react-icons/fa'; // Icons
...
const FacultyDashboard = ({ facultyData, setIsAuthenticated, setIsFaculty }) => {
  ...
  const [tasks] = useState([]); // Shared Tasks
